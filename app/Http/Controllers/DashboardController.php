...
// {
//     // URL API
//     $url = 'http://34.101.194.89:5400/api/error-logs/RR8TC01JF4R';

//     // Melakukan permintaan GET ke API dengan header api-key
//     $response = Http::withHeaders([
//         'api-key' => 'M4nagement!'
//     ])->get($url);

//     // Memeriksa jika response berhasil (kode status 200)
//     if ($response->successful()) {
//         // Mengambil data JSON dari response
//         $errorLogs = $response->json();

//         // Filter untuk mengambil perangkat dengan status error
//         $errorDevices = collect($errorLogs)->filter(function ($item) {
//             return isset($item['status']) && $item['status'] === 'error';
//         });

//         // Mengirim data perangkat error ke view
//         return view('dashboard.dashboard', compact('errorDevices'));
//     } else {
